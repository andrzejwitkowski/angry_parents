            ...
            <Tooltip>
                <TooltipTrigger asChild>
                    <TimelineHistoryDialog
                        item={item}
                        trigger={
                            <div className="flex items-center gap-1.5 cursor-pointer hover:bg-amber-100 rounded-full px-2.5 py-1 transition-all border border-amber-200 bg-amber-50 shadow-sm hover:shadow-md animate-in fade-in zoom-in duration-300">
